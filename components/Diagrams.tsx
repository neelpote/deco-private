...
import { Play, RotateCcw, Activity, Cpu, BarChart2, Shield } from 'lucide-react';
...
export const SurfaceCodeDiagram: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-white rounded-xl shadow-sm border border-stone-200 my-8">
      <h3 className="font-serif text-xl mb-4 text-stone-800">Interactive: Shielded Voting Verification</h3>
      <p className="text-sm text-stone-500 mb-6 text-center max-w-md">
        Click the grey <strong>Private Voters</strong> to simulate encrypted ballots. Watch the <strong>TEE Verifiers</strong> light up as they validate the zero-knowledge parity.
      </p>
      ...
      <div className="mt-6 flex items-center gap-4 text-xs font-mono text-stone-500">
          <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-full bg-stone-800"></div> Encrypted Ballot</div>
          <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-sm bg-blue-500"></div> ZK-Check A</div>
          <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-sm bg-red-500"></div> ZK-Check B</div>
      </div>
      
      <div className="mt-4 h-6 text-sm font-serif italic text-stone-600">
        {errors.length === 0 ? "Network is shielded." : `Verified ${activeStabilizers.length} private state transitions.`}
      </div>
    </div>
  );
};
...
export const TransformerDecoderDiagram: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-[#F5F4F0] rounded-xl border border-stone-200 my-8">
      <h3 className="font-serif text-xl mb-4 text-stone-900">PER Rollup Architecture</h3>
      <p className="text-sm text-stone-600 mb-6 text-center max-w-md">
        The Private Ephemeral Rollup processes encrypted transactions within a TEE, ensuring verifiable privacy before settlement.
      </p>
      ...
      <div className="relative w-full max-w-lg h-56 bg-white rounded-lg shadow-inner overflow-hidden mb-6 border border-stone-200 flex items-center justify-center gap-8 p-4">
        ...
        <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] uppercase font-bold tracking-wider text-stone-500">Private Tx</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
             ...
             <span className="text-[10px] uppercase font-bold tracking-wider text-stone-500">TEE Processor</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] uppercase font-bold tracking-wider text-stone-500">Settled State</span>
        </div>
    ...
    return (
        <div className="flex flex-col md:flex-row gap-8 items-center p-8 bg-stone-900 text-stone-100 rounded-xl my-8 border border-stone-800 shadow-lg">
            <div className="flex-1 min-w-[240px]">
                <h3 className="font-serif text-xl mb-2 text-nobel-gold">Privacy vs Efficiency</h3>
                <p className="text-stone-400 text-sm mb-4 leading-relaxed">
                    Deco Private optimizes the trade-off between cryptographic overhead and transaction speed using ephemeral rollups.
                </p>
                ...
                <div className="mt-6 font-mono text-xs text-stone-500 flex items-center gap-2">
                    ...
                    <span>DATA LEAKAGE RISK (LOWER IS BETTER)</span>
                </div>
            </div>
            ...
            <div className="relative w-64 h-72 bg-stone-800/50 rounded-xl border border-stone-700/50 p-6 flex justify-around items-end">
                ...
                <div className="w-20 flex flex-col justify-end items-center h-full z-10">
                    ...
                    <div className="h-6 flex items-center text-xs font-bold text-stone-500 uppercase tracking-wider">Public</div>
                </div>
                ...
                <div className="w-20 flex flex-col justify-end items-center h-full z-10">
                     ...
                     <div className="h-6 flex items-center text-xs font-bold text-nobel-gold uppercase tracking-wider">Shielded</div>
                </div>
            </div>
        </div>
    )
